...
<link href="<?php base_url() ?>dashboard" rel="stylesheet">
  ...
  <div class="container">
    ...
    <div class="right">
      <svg viewBox="0 0 320 300">
        ...
        -25,38.5 0,34.48652 25,38.5 25,38.5 h 215 c 0,0 20,-0.99604 20,-25 0,-24.00396 -20,-25 -20,-25 h -190 c 0,0 -20,1.71033 -20,25 0,24.00396 20,25 20,25 h 168.57143" />
      </svg>
      <div class="form">
      ...
      <form action="<?php base_url() ?>dashboard" method="post">
        ...
        <input type="submit" id="entrar" class="btn btn-outline-success btn btn-md" 
...
/*estillo css que define a aparência da tela de login*/
::selection {
  background: #2D2F36;
}
::-webkit-selection {
